...
echo color("red","| github: Mas Zulfadli |\n");
echo color("red","| initial : karepmu|\n");
echo color("red","| Creator : wong edan          |\n");
echo "| Version : Nek gelem bayar nek ra gelem bayar yo wes      |\n";
